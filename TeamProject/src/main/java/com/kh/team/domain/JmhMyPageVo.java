...
public class JmhMyPageVo {
	...
	public String toString() {
		return "JmhMyPageVo [user_id=" + user_id + ", user_pw=" + user_pw + ", user_name=" + user_name
				+ ", user_gender=" + user_gender + ", user_email=" + user_email + ", user_birth=" + user_birth
				+ ", user_phone=" + user_phone + ", user_address=" + user_address + ", user_total_money="
				+ user_total_money + ", user_point=" + user_point + ", user_sms_check=" + user_sms_check + ", user_num="
				+ user_num + ", user_join_date=" + user_join_date + ", user_out_check=" + user_out_check
