...
public class JmhMovieVo {
	...
	public String toString() {
		return "JmhMovieVo [movie_code=" + movie_code + ", movie_name=" + movie_name + ", movie_genre=" + movie_genre
				...
				+ movie_preview + ", movie_num=" + movie_num + ", movie_sub_image=" + movie_sub_image + "]";
	}
}