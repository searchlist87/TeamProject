...
public class JmhUserVo {
	...
	public String toString() {
		return "JmhUserVo [user_id=" + user_id + ", user_pw=" + user_pw + ", user_name=" + user_name + ", user_gender="
				...
				+ ", user_point=" + user_point + ", user_sms_check=" + user_sms_check + ", user_num=" + user_num
				+ ", user_join_date=" + user_join_date + ", user_out_check=" + user_out_check + ", user_class="
				+ user_class + "]";
	}
