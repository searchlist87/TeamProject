	...
	<div class="shop-sidebar">
			...
			<div class="single-widget category">
				...
				<dl class="categor-list" id="board_manage">
					...
					<dd><a href="/admin/admin_notice_list" class="sub_menu">공지사항 조회</a></dd>
					<dd><a href="/admin/admin_notice_register" class="sub_menu">공지사항 등록</a></dd>
				...
				<dl class="categor-list" id="review_manage">
					...
					<dd><a href="/gsh/admin/admin_review_list" class="sub_menu">리뷰 조회</a></dd>
				</dl>
