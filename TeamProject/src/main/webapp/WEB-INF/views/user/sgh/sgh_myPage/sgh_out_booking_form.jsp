							...
							<div class="row">
								...
								<!--  							이전 -->
														<c:if test="${sghPagingDto.start_page != 1}">
															<li class="page-item"><a class="page-link" href="/sgh/myPage/outBookingForm?start_page=${sghPagingDto.start_page - 1}">&laquo;</a></li>
														</c:if>
								<!--  								페이지 넘버링 -->
														...
														<li class="page-item
																...
																"
															>
																<a class="page-link" href="/sgh/myPage/outBookingForm?page=${v}" style="float: left;">${v}</a>
															</li>
														</c:forEach>
								<!--  								다음 -->
														<c:if test="${sghPagingDto.end_page < sghPagingDto.total_page}">
															<li class="page-item"><a class="page-link" href="/sgh/myPage/outBookingForm?end_page=${sghPagingDto.end_page + 1}">&raquo;</a></li>
														</c:if>
													</ul>
												</nav>
											</div>
