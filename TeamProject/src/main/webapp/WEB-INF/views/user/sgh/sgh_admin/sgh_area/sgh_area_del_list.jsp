				...
				<div class="row">
					<div class="col-12">
						...
						<div style="margin-top: 10px;">
							<a href="/sgh/admin/areaListForm" class="btn-sm" style="background-color: black; color: white;">등록된 지역</a>
							<a href="/sgh/admin/deleteAreaListForm" class="btn-sm" style="background-color: orange; color: white;">삭제된 지역</a>
						</div>
						<!--  페이지별 내용 -->
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td>${SghAreaVo.area_del_date}</td>
												<td><a href="/sgh/admin/areaRestore?area_code=${SghAreaVo.area_code}" class="btn-warning" style="color: white;">복구</a></td>
											</tr>
											</c:forEach>
										</tbody>
									</table>
