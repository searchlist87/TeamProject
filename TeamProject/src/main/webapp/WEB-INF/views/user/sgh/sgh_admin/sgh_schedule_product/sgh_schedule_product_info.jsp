...
$(function() {
	...
	var movie_time_code = "${sghMovieProductVo.movie_time_code}"
	var url = "/sgh/admin/scheduleProduct/seatCheckAjax";
	var sendData = {
						...
						<div class="modal-body">
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="movie_time" value="${sghMovieProductVo.movie_start_time} ~ ${sghMovieProductVo.movie_end_time}" readonly/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="seat_name"> 구매자 </label>
									<input type="text" class="form-control" readonly/>
								</div>
								<div class="form-group">
									<label for="seat_name"> 구매 시간 </label>
									<input type="text" class="form-control" readonly/>
								</div>
							</div>
										...
										<div class="row" style="margin-top: 20px;">
											<div class="col-md-12">
												<div class="jumbotron">
													...
													<a class="btn-primary btn-large" href="/sgh/admin/scheduleProduct/scheduleProductList">목록</a>
												</div>
												<div>
													<strong style="text-align: center;"><p style="text-align: center;">영화 스크린</p></strong>
													<table id="seat_table">
														<tbody>
														<c:forEach items="${seat_col_Array}" var="col">
															<tr>
															<c:forEach begin="1" end="${sghMovieProductVo.screen_seat_row}" var="row">
															<td class="seat">${col}${row}</td>
															</c:forEach>
															</tr>
														</c:forEach>
														</tbody>
