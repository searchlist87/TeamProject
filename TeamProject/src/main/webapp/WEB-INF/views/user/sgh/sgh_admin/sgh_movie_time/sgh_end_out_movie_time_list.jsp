							...
							<div class="row">
								<div class="col-md-12">
									...
									<div style="margin-top: 10px;">
										...
										<a href="/sgh/admin/movieTime/endOupMovieTimeList" class="btn-sm" style="background-color: orange; color: white;">기간이 지난 상영작 목록</a>
									</div>
									<div class="container-fluid">
										<div class="row">
...
<!--  							이전 -->
						<c:if test="${sghPagingDto.start_page != 1}">
							<li class="page-item"><a class="page-link" href="/sgh/admin/movieTime/endOupMovieTimeList?start_page=${sghPagingDto.start_page - 1}">&laquo;</a></li>
						</c:if>
<!--  								페이지 넘버링 -->
						...
						<li class="page-item
								...
								"
							>
								<a class="page-link" href="/sgh/admin/movieTime/endOupMovieTimeList?page=${v}" style="float: left;">${v}</a>
							</li>
						</c:forEach>
<!--  								다음 -->
						<c:if test="${sghPagingDto.end_page < sghPagingDto.total_page}">
							<li class="page-item"><a class="page-link" href="/sgh/admin/movieTime/endOupMovieTimeList?end_page=${sghPagingDto.end_page + 1}">&raquo;</a></li>
						</c:if>
					</ul>
				</nav>
			</div>
